...
func (x *AuthMetadata) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
type Playlist struct {
	...
	UserId      string   `protobuf:"bytes,3,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // Владелец плейлиста
	...
	IsPublic    bool     `protobuf:"varint,8,opt,name=is_public,json=isPublic,proto3" json:"is_public,omitempty"` // Добавляем флаг публичности
}
...
type Track struct {
	...
	UserId   string `protobuf:"bytes,6,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // Владелец трека
}
...
type CreatePlaylistRequest struct {
	...
	UserId      string   `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // Должен совпадать с JWT
...
type GetUserPlaylistsRequest struct {
	...
	UserId        string `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	IncludePublic bool   `protobuf:"varint,2,opt,name=include_public,json=includePublic,proto3" json:"include_public,omitempty"` // Флаг для включения публичных плейлистов
}
...
func (x *GetUserPlaylistsRequest) GetIncludePublic() bool {
	if x != nil {
...
type AddTrackRequest struct {
	...
	UserId     string `protobuf:"bytes,3,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // Для проверки прав
}
...
type DeletePlaylistRequest struct {
	...
	Id     string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	UserId string `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // Должен совпадать с владельцем
}
...
var file_playlist_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x70, 0x6c, 0x61, 0x79, 0x6c, 0x69, 0x73, 0x74, 0x22, 0x3d, 0x0a, 0x0c, 0x41, 0x75,
	0x74, 0x68, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73,
	0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65,
	0x72, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xed, 0x01, 0x0a, 0x08, 0x50, 0x6c,
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x27, 0x0a, 0x06, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x18,
	0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x70, 0x6c, 0x61, 0x79, 0x6c, 0x69, 0x73, 0x74,
	0x2e, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x52, 0x06, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x12, 0x1d,
	...
	0x08, 0x69, 0x73, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x22, 0x90, 0x01, 0x0a, 0x05, 0x54, 0x72,
	...
	0x62, 0x75, 0x6d, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x06,
	...
	,
	...
	,
	...
	0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0xdb, 0x03, 0x0a,
	0x0f, 0x50, 0x6c, 0x61, 0x79, 0x6c, 0x69, 0x73, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x12, 0x47, 0x0a, 0x0e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x6c, 0x61, 0x79, 0x6c, 0x69,
	0x73, 0x74, 0x12, 0x1f, 0x2e, 0x70, 0x6c, 0x61, 0x79, 0x6c, 0x69, 0x73, 0x74, 0x2e, 0x43, 0x72,
	...
	,
...
var file_playlist_proto_goTypes = []interface{}{
	(*AuthMetadata)(nil),            // 0: playlist.AuthMetadata
	(*Playlist)(nil),                // 1: playlist.Playlist
	(*Track)(nil),                   // 2: playlist.Track
	(*CreatePlaylistRequest)(nil),   // 3: playlist.CreatePlaylistRequest
	(*GetPlaylistRequest)(nil),      // 4: playlist.GetPlaylistRequest
	(*GetUserPlaylistsRequest)(nil), // 5: playlist.GetUserPlaylistsRequest
	(*PlaylistList)(nil),            // 6: playlist.PlaylistList
	(*AddTrackRequest)(nil),         // 7: playlist.AddTrackRequest
	(*RemoveTrackRequest)(nil),      // 8: playlist.RemoveTrackRequest
	(*DeletePlaylistRequest)(nil),   // 9: playlist.DeletePlaylistRequest
	(*DeletePlaylistResponse)(nil),  // 10: playlist.DeletePlaylistResponse
}
var file_playlist_proto_depIdxs = []int32{
	2,  // 0: playlist.Playlist.tracks:type_name -> playlist.Track
	2,  // 1: playlist.CreatePlaylistRequest.tracks:type_name -> playlist.Track
	1,  // 2: playlist.PlaylistList.playlists:type_name -> playlist.Playlist
	2,  // 3: playlist.AddTrackRequest.track:type_name -> playlist.Track
	3,  // 4: playlist.PlaylistService.CreatePlaylist:input_type -> playlist.CreatePlaylistRequest
	4,  // 5: playlist.PlaylistService.GetPlaylist:input_type -> playlist.GetPlaylistRequest
	5,  // 6: playlist.PlaylistService.GetUserPlaylists:input_type -> playlist.GetUserPlaylistsRequest
	7,  // 7: playlist.PlaylistService.AddTrackToPlaylist:input_type -> playlist.AddTrackRequest
	8,  // 8: playlist.PlaylistService.RemoveTrackFromPlaylist:input_type -> playlist.RemoveTrackRequest
	9,  // 9: playlist.PlaylistService.DeletePlaylist:input_type -> playlist.DeletePlaylistRequest
	...
	6,  // 12: playlist.PlaylistService.GetUserPlaylists:output_type -> playlist.PlaylistList
	1,  // 13: playlist.PlaylistService.AddTrackToPlaylist:output_type -> playlist.Playlist
	1,  // 14: playlist.PlaylistService.RemoveTrackFromPlaylist:output_type -> playlist.Playlist
	10, // 15: playlist.PlaylistService.DeletePlaylist:output_type -> playlist.DeletePlaylistResponse
